...
import { createNews, createProject, deleteHeroImage, deleteNews, deleteProject, fetchNews, fetchProjects, fetchQuotes, updateHero, updateNews, updateProject, updateQuoteStatus, uploadHeroImage } from '../../lib/api'
...
export default function AdminWebsitePanel({ tab = 'quotes' }) {
